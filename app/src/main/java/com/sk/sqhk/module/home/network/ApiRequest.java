...
public class ApiRequest extends BaseApiRequest {
    ...
    public static void getHotXinYongCard(Map map, MyCallBack callBack) {
        if (notNetWork(callBack.getContext())) { callBack.onFailure(null, new NoNetworkException(Config.noNetWork)); return;  }
        getGeneralClient(IRequest.class).getHotXinYongCard(map).enqueue(callBack);
    }
    public static void daiKuanShenQing(Map map, MyCallBack callBack) {
        if (notNetWork(callBack.getContext())) { callBack.onFailure(null, new NoNetworkException(Config.noNetWork)); return;  }
        getGeneralClient(IRequest.class).daiKuanShenQing(map).enqueue(callBack);
    }
    public static void getHomeGongGao(Map map, MyCallBack callBack) {
        if (notNetWork(callBack.getContext())) { callBack.onFailure(null, new NoNetworkException(Config.noNetWork)); return;  }
        getGeneralClient(IRequest.class).getHomeGongGao(map).enqueue(callBack);
    }
