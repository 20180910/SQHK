...
public interface IRequest {
    ...
    //创建急速还款
    @GET("api/HandleCardOnline/GetCreatePlan")
    Call<ResponseObj<BaseObj>> addJiSuHuanKuan(@QueryMap Map<String, String> map);
    ...
    //在线办卡获取热门信用卡
    @GET("api/HandleCardOnline/GetHotCreditCard")
    Call<ResponseObj<List<HotXinYongCardObj>>> getHotXinYongCard(@QueryMap Map<String, String> map);
    ...
    //首页公告
    @GET("api/Informations/GetAnnouncement")
    Call<ResponseObj<List<HomeGongGaoObj>>> getHomeGongGao(@QueryMap Map<String, String> map);
